...
reportEmi <- function(gdx, output = NULL, regionSubsetList = NULL, t = c(seq(2005, 2060, 5), seq(2070, 2110, 10), 2130, 2150)) {
  ...
  out <- mbind(out,
               ...
               setNames((dimSums(EmiFeCarrier, dim = 3)
                         ...
                         - dimSums(vm_emiIndCCS[, , emiInd37_fuel], dim = 3)*p_share_CCS) * GtC_2_MtCO2,
  ...
  out <- mbind(out,
               ...
               # (carbon captured by industry used for CCU is still accounted as industry emissions as only account negative emissions for the CO2 provider if carbon gets stored)
               setNames((dimSums(EmiFeCarrier[, , "indst"], dim = 3) - dimSums(vm_emiIndCCS[, , emiInd37_fuel]* p_share_CCS, dim = 3) ) * GtC_2_MtCO2,
  ...
  if (!is.null(o37_demFeIndSub)) {
    ...
    mixer <- tribble(
      ...
      '+|Solids',                           NULL,          'fesos',      NULL,
      'Solids|+|Fossil',                    NULL,          'fesos',      NULL,
      'Solids|+|Biomass',                   NULL,          'fesos',      NULL,
      '+|Liquids',                          NULL,          'fehos',      NULL,
      'Liquids|+|Fossil',                   NULL,          'fehos',      NULL,
      'Liquids|+|Biomass',                  NULL,          'fehos',      NULL,
      'Liquids|+|Synfuel',                  NULL,          'fehos',      NULL,
      '+|Gases',                            NULL,          'fegas',      NULL,
      'Gases|+|Fossil',                     NULL,          'fegas',      NULL,
      'Gases|+|Biomass',                    NULL,          'fegas',      NULL,
      'Gases|+|Synfuel',                    NULL,          'fegas',      NULL,
      ...
      'Cement|Solids|+|Synfuel',            'cement',       'fesos',     entySEsyn,
      ...
      'Chemicals|Solids|+|Synfuel',         'chemicals',    'fesos',     entySEsyn,
      ...
      'Steel|Solids|+|Synfuel',             'steel',        'fesos',     entySEsyn,
      'Steel|+|Liquids',                    'steel',        'fehos',     NULL,
      'Steel|Liquids|+|Fossil',             'steel',        'fehos',     entySEfos,
      ...
      'Other Industry|++|Fossil',           'otherInd',      NULL,        entySEfos,
      'Other Industry|++|Biomass',          'otherInd',      NULL,        entySEbio,
      'Other Industry|++|Synfuel',          'otherInd',      NULL,        entySEsyn,
      'Other Industry|+|Solids',            'otherInd',      'fesos',     NULL,
      'Other Industry|Solids|+|Fossil',     'otherInd',      'fesos',     entySEfos,
      'Other Industry|Solids|+|Biomass',    'otherInd',      'fesos',     entySEbio,
      'Other Industry|Solids|+|Synfuel',    'otherInd',      'fesos',     entySEsyn,
      'Other Industry|+|Liquids',           'otherInd',      'fehos',     NULL,
      'Other Industry|Liquids|+|Fossil',    'otherInd',      'fehos',     entySEfos,
      'Other Industry|Liquids|+|Biomass',   'otherInd',      'fehos',     entySEbio,
      'Other Industry|Liquids|+|Synfuel',   'otherInd',      'fehos',     entySEsyn,
      'Other Industry|+|Gases',             'otherInd',      'fegas',     NULL,
      'Other Industry|Gases|+|Fossil',      'otherInd',      'fegas',     entySEfos,
      'Other Industry|Gases|+|Biomass',     'otherInd',      'fegas',     entySEbio,
      'Other Industry|Gases|+|Synfuel',     'otherInd',      'fegas',     entySEsyn) %>%
      mutate(
